...
//               <th className="px-4 py-3 text-center border-b">College</th>
//               <th className="px-4 py-3 text-center border-b">Description</th>
...
//               <tr key={d.department_id} className="hover:bg-blue-50">
//                 <td className="px-4 py-2 text-center">{d.department_id}</td>
//                 <td className="px-4 py-2 text-center">{d.name}</td>
//                 <td className="px-4 py-2 text-center">{d.college_name || d.college}</td>
//                 <td className="px-4 py-2 text-center">{d.description || '-'}</td>
...
//             <h3 className="font-bold mb-2">Edit Department</h3>
