    ...
    <Layout>
      <div className="p-6 space-y-6">
        <div>
          ...
          <p className="text-sm text-slate-400 mt-1">مسؤوليات: الدعم والمساندة للمشرف الرئيسي، مراجعة مقترحات المشاريع، متابعة الطلبات الموضوعة</p>
        </div>
        ...
        <div className="border-b border-gray-200 flex gap-8">
          ...
          <button onClick={() => setActiveTab('groups')} className={`pb-4 font-semibold ${activeTab === 'groups' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-600'}`}>
            المجموعات
          </button>
        </div>
